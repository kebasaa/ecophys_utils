...
def load_li6400(input_fn: str, silent: bool = True) -> pd.DataFrame:
    """
    Load a single LI-6400XT portable photosynthesis system file.

    Parameters
    ----------
    input_fn : str
        Path to the LI-6400 file.
...
def load_all_li6400(path: str, silent: bool = False) -> pd.DataFrame:
    """
    Load all LI-6400 files from a directory.

    Parameters
    ----------
    path : str
        Directory path containing LI-6400 files.
    silent : bool, optional
